      ...
      <section className="register-form-section" style={{alignItems:'center'}}>
        ...
        <form onSubmit={handleSubmit} className="glass-card" style={{maxWidth: 420, width:'100%'}}>
          <div className="full-width">
            <label>Email</label>
            <input type="email" value={email} onChange={e=>setEmail(e.target.value)} placeholder="Enter your account email" disabled={!manualMode} required />
          </div>
          ...
          <div className="full-width">
            ...
            <div style={{ position: 'relative' }}>
              <input type={showPwd ? 'text' : 'password'} value={password} onChange={e=>{ setPassword(e.target.value); setPwdStrength(computeStrength(e.target.value)); }} placeholder="Create a strong password" required disabled={!verified} />
          ...
          <div className="full-width">
            ...
            <div style={{ position: 'relative' }}>
              <input type={showConfirm ? 'text' : 'password'} value={confirm} onChange={e=>setConfirm(e.target.value)} placeholder="Re-enter password" required disabled={!verified} />
